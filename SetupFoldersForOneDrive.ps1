...
$ONEDRIVESYNC = "$env:USERPROFILE\OneDrive - Columbus Consolidated Government"
...
#Set-ItemProperty -Path HKCU:\SOFTWARE\Microsoft\OneDrive -Name DisableCustomRoot -Type DWORD -Value 1
